...
5. ✨ Ссылка на видео автоматически откроется в Qwen (лишние параметры URL будут удалены)
...
| 🎬 **Open YT Link in Qwen** | Отправляет ссылку на YouTube видео в Qwen (только на YouTube) |
