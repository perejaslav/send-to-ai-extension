...
- 🎬 **YouTube Integration** — отправляй ссылки на видео в Qwen одним кликом
...
3. 🤖 Наведи на **«Отправить в AI»**
4. 🎬 Выбери **«Open YT Link in Qwen»**
5. ✨ Ссылка на видео автоматически откроется в Qwen вместе с запросом на извлечение саммари.
...
| 🎬 **Open YT Link in Qwen** | Отправляет ссылку на YouTube видео в Qwen с запросом на создание саммари (только на YouTube) |
