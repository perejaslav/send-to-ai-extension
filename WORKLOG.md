...
- Разделил YouTube-меню Gemini на два пункта: для подробной статьи по транскрипции и для краткого резюме основных фактов
- Добавил отдельный prompt-builder для краткого резюме YouTube-видео в `youtube.js`
- Обновил тесты, README-файлы и поднял версию расширения до `3.3` / `3.3.0`
